...
const url_region = `https://apis.data.go.kr/B551011/KorService1/areaCode1?serviceKey=${apiKey}&numOfRows=50&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json`;
const url_detailRegion = `https://apis.data.go.kr/B551011/KorService1/areaCode1?serviceKey=${apiKey}&numOfRows=100&pageNo=1&MobileOS=ETC&MobileApp=AppTest&areaCode=1&_type=json`;
...
const url_region_tourInfo = `https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=50&pageNo=1&MobileOS=ETC&MobileApp=study&_type=json&areaCode=1&sigunguCode=1&serviceKey=${apiKey}`;

const url_location_tourInfo = `https://apis.data.go.kr/B551011/KorService1/locationBasedList1?numOfRows=100&MobileOS=ETC&MobileApp=study&mapX=127.919482&mapY=37.341868&radius=3000&serviceKey=${apiKey}`;
